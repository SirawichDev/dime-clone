<template>
  <div class="container mx-auto pb-20">
    <div
      class="bg-blue-600 opacity-90 mt-[15%] mb-[5%] mx-0 lg:mx-[10%] min-h-fit lg:h-[450px] px-20 pt-10 rounded-xl flex justify-around items-center flex-wrap lg:flex-nowrap flex-wrap"
    >
      <div
        class="flex flex-col gap-10 items-center lg:items-start lg:text-left text-center"
      >
      ...
      >
        <img
          alt="phone-frame"
          class="relative bottom-[-40px] z-2"
          src="https://dime.co.th/story-hero-phone-frame.webp"
        />
        <img
          alt="phone-base"
          class="relative mb-0 bottom-0 z-1"
          src="https://dime.co.th/story-hero-phone-base.svg"
        />
      </div>
    </div>
    <DownloadStore />
